export const data = [
  {
    name: "ジン",
    character: "長身痩躯の冷酷な男。鋭い観察力と狙撃の腕を持つ。赤井のライバル",
    detail:
  ...
  {
    name: "ウォッカ",
    character: "ジンの部下で、行動をともにしている。組織への忠誠心が高い。",
    detail:
  ...
  },
  {
    name: "ベルモット",
    character:
      "表の顔はハリウッド女優。黒ずくめの組織の幹部であり、「あの方」のお気に入り。",
    detail:
  ...
  },
  {
    name: "スコッチ",
    character:
      "以前降谷零と共に組織に潜入していた公安警察官。スナイパーとして活躍しバーボンとライとともに行動していた。だが潜入捜査官であることを組織に知られてしまい...",
    detail:
      "スコットランドで作られているウイスキー。全世界のウイスキーの約６割を占めているといわれている。大麦麦芽を単式蒸溜器で2回蒸溜するモルトウイスキー、主にトウモロコシを連続蒸溜器で蒸溜したグレーンウイスキー、この2つを混合したブレンデッドウイスキーがある。",
    data: true,
  },
